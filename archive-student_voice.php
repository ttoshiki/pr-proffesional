  ...
  <main>
    ...
    <div class="voicePageMv">
      <div class="voicePageMv__bg">
        <img src="<?php echo get_template_directory_uri(); ?>/voice/img/voice-mv.jpg" alt="" class="pc">
        <img src="<?php echo get_template_directory_uri(); ?>/voice/img/voice-mv_sp.jpg" alt="" class="sp">
      </div>
      <h1 class="voicePageMv__ttl">受講生の声</h1>
      <p class="voicePageMv__txt">
        630名以上の方がPRの力で<br class="sp">未来を変えています。<br>
        未経験者から経営者まで、<br class="sp">様々な方が成果を出しています。
      </p>
    </div>
    <!-- //voicePageMv -->
    ...
    <div class="voicePageHead">
      <div class="voicePageInner">
        ...
        <ul class="voicePageHead__termList">
          <li class="voicePageHead__term current"><a href="/student_voice">ALL</a></li>
          <li class="voicePageHead__term"><a href="/student_voice_cat/company-pr">自社をPRしたい</a></li>
