...
jQuery(function ($) {
	...
	if (!mobile) {
		$(".youtubeModalOpen").modalVideo();
	} else {
		function onPlayerReady(event) {
			event.target.playVideo();
		}
		$('#appeal_of_prYTPlay').click(function() {
			//Youtube埋め込み
			var player;
			player = new YT.Player('appeal_of_pr', {
				height: '100%',
				width: '100%',
				playerVars: {
					autoplay: 1,
		...
		$('#kizaki_yukoYTPlay').click(function() {
			//Youtube埋め込み
			var player;
			player = new YT.Player('kizaki_yukoMovie', {
				height: '100%',
				width: '100%',
				playerVars: {
					autoplay: 1,
		...
		$('#ueda_yuichiYTPlay').click(function() {
			//Youtube埋め込み
			var player;
			player = new YT.Player('ueda_yuichiMovie', {
				height: '100%',
				width: '100%',
				playerVars: {
					autoplay: 1,
		...
		$('#tango_kayoYTPlay').click(function() {
			//Youtube埋め込み
			var player;
			player = new YT.Player('tango_kayoMovie', {
				height: '100%',
				width: '100%',
				playerVars: {
					autoplay: 1,
		...
		$('#ando_shinnosukeYTPlay').click(function() {
			//Youtube埋め込み
			var player;
			player = new YT.Player('ando_shinnosukeMovie', {
				height: '100%',
				width: '100%',
				playerVars: {
					autoplay: 1,
		...
		$('#digestMovieYTPlay').click(function() {
			//Youtube埋め込み
			var player;
			player = new YT.Player('digestMovie', {
				height: '100%',
				width: '100%',
				playerVars: {
					autoplay: 1,
		...
		$('#onlineYTPlay').click(function() {
			//Youtube埋め込み
			var player;
			player = new YT.Player('onlineMovie', {
				height: '100%',
				width: '100%',
				playerVars: {
					autoplay: 1,
			...
			$('.online__youtubeThubmnail').hide();
			$('.online__youtubeThubmnailIcon').hide();
		});
		$(".onlineMovieLink").modalVideo();
	}
});
